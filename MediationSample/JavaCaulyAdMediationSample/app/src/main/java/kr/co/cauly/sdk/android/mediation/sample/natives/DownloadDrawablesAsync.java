...
public class DownloadDrawablesAsync extends AsyncTask<Object, Void, HashMap<String, Drawable>> {
    ...
    protected HashMap<String, Drawable> doInBackground(Object... params) {
        ...
        Future<Drawable> imageDrawableFuture = getDrawableFuture(urlsMap.get(KEY_IMAGE), executorService);
        ...
        try {
            ...
            Log.e("DownloadDrawablesAsyn", "Native ad images failed to download.");
            return null;
        }
    }
